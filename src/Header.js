...
function Header() {
  ...
  return (
    ...
    <Link to="/productLocationSelect" style={{ textDecoration: "none" , color: '#000' }}><div style = {location.pathname == "/productLocation" || location.pathname == "/productLocationSelect" ? {backgroundColor: '#f2f2f2', color: '#000'} : null} className="main_tab_second_box">
        <p>상품 위치</p>
    </div></Link>
</header>
  )
